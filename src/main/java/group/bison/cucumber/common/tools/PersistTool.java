package group.bison.cucumber.common.tools;
...
public class PersistTool implements InitializingBean {
    ...
    public static void setVal(String key, String val) {
        instance.redisTemplate.opsForValue().set(getRedisKey(key), val, 24 * 60 * 60, TimeUnit.SECONDS);
    }
    ...
    static String getRedisKey(String key) {
        return String.join("","cucumber-test#", key);
    }
